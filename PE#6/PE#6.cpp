 ...
 * (1 + 2 + 3 + ... + 10) = 3025 Hence the difference between the sum of the
...
uint64_t SumOfSqauresOfN(uint64_t n) { return n * (n + 1) * (2 * n + 1) / 6; }

int main() { cout << SquareOfSumN(100) - SumOfSqauresOfN(100); }
